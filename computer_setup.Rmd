...
### Please complete these 5 main tasks before our first class:
 ...
 2. Fill out this Google Form: https://forms.gle/YahVutQ6Ds1CpHFP6
 
 3. <img src="img/R_logo.png" alt="R" width = "6%"> &nbsp; Install *current* [**R**](https://cran.rstudio.com/) on your laptop
 
 4. <img src="img/Rstudio_icon.png" alt="RStudio" width = "6%"> &nbsp; Install *current* [**RStudio**](https://www.rstudio.com/products/rstudio/download/) on your laptop
 
 5. <i class="fa fa-table fa-2x" aria-hidden="true"></i> &nbsp; Make sure you have a spreadsheet program installed on your computer (Microsoft Office, Libre Office, etc.)
...
Much of the instruction below is from a great website set up by Jenny Bryan, called *happygitwithr.com*.
 ...
 2. Tell us your GitHub username using this [Google Form](https://forms.gle/ZUWcMEfwWrHRsDai9), so we can add you to the class Github Organization, **ucd-r-davis** (which is basically our own github "classroom"). We will set up a private repository for each student. So you just need the free individual account (i.e. we don’t have to wait for your Student Developer Pack to get approved).
 
 3. Please look for an invitation to join the [UCD-R-Davis Organization](https://github.com/ucd-r-davis) in your email. Once that's all done, we can create and add a private **repo**sitory that belongs only to you. Other students can see this repo, but they cannot edit it. The rest of the world cannot see it, only our class.
